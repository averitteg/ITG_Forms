<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Default.Master" CodeBehind="frmBasic1cbl.aspx.vb" Inherits="ITG_FORMS.frmBasic1cbl" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="BodyContent" runat="server">
        ...
        <asp:Panel ID="pnlFormHeader" runat="server">
            ...
            <br />
            <br />
            <asp:Literal ID="litCblLabel" runat="server"></asp:Literal><asp:CheckBoxList ID="cblOptions" runat="server"></asp:CheckBoxList>
            <br />
            <br />
            <table>
                <tr><td>
